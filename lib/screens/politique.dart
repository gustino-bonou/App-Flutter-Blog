...
class _PolitiqueArticle extends State<PolitiqueArticle> {
  ...
  Future<Article> getLateArticlesFromCollection() async {
    ...
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('articles').where("category", isEqualTo: "Politic").orderBy("datePosted", descending: true).get();
